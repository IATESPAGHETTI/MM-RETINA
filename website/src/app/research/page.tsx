  ...
  return (
    <div className="pt-20">
      <section className="mx-auto max-w-3xl px-6 pt-20 pb-8 text-center">
        <Reveal>
          <p className="mb-3 text-xs uppercase tracking-widest text-ink-faint">Research</p>
      ...
      <section className="mx-auto max-w-3xl px-6 py-8">
        <Reveal>
          <GlassCard className="text-base leading-relaxed text-ink-muted">
            <p>
      ...
      <section className="mx-auto max-w-3xl px-6 py-8">
        <Reveal>
          <h2 className="mb-4 text-2xl font-semibold text-ink">A short glossary</h2>
        </Reveal>
        <Reveal delay={0.1}>
          <GlassCard>
            <dl className="space-y-4 text-sm text-ink-muted">
              <div>
                ...
                <dd>One cross-sectional slice of an OCT volume — like one page of a flip-book showing a slice through the retina.</dd>
              </div>
              <div>
                <dt className="font-medium text-ink">Embedding</dt>
                <dd>A list of numbers a neural network produces to summarize an image&apos;s important features, in a form a computer can compare and combine.</dd>
              </div>
              <div>
                <dt className="font-medium text-ink">Cross-attention</dt>
                <dd>A mechanism that lets one type of data (e.g. OCT) inform how much weight to give parts of another type of data (e.g. fundus), instead of just averaging them.</dd>
              </div>
              <div>
                <dt className="font-medium text-ink">Patient-level split</dt>
                <dd>Dividing data into train/validation/test by patient, not by individual image — so the model is never tested on a patient it has already partly seen.</dd>
              </div>
            </dl>
          </GlassCard>
        </Reveal>
